...
def generate_launch_description():
    ...
    set_param1 = ExecuteProcess(
        cmd=[["ros2 param set", " ros2_launch_talker_node", " param1", " 77"]],
        shell=True,
    )
    ...
    conditional_set_param2 = ExecuteProcess(
        # Condition
        condition=IfCondition(PythonExpression([set_param2, " == True"])),
        cmd=[["ros2 param set ros2_launch_talker_node", " param2", " 88"]],
        shell=True,
    )
