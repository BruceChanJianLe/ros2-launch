...
def generate_launch_description():
        ...
        configuration1_talker_node = Node(
            ...
            parameters=[PathJoinSubstitution([get_package_share_directory('ros2-launch'), 'config', LaunchConfiguration('configuration_selection1'),'params.yaml'])],
        )
        ...
        configuration2_talker_node = Node(
            ...
            parameters=[PathJoinSubstitution([get_package_share_directory('ros2-launch'), 'config', LaunchConfiguration('configuration_selection2'),'params.yaml'])],
        )
